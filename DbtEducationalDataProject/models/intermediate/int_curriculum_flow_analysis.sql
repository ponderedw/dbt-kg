...
curriculum_pathways as (
    select
        student_id,
        string_agg(course_code, ' -> ' order by sequence_order) as learning_pathway,
        ...
        avg(case when prerequisite_course_id is not null then courses_between_prerequisite end) as avg_gap_from_prerequisite,
